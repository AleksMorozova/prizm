namespace Prizm.Main.Forms.Reports.Construction
{
    partial class TracingReporn
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.TracingGroupHeader.HeightF = 61.45833F;
            ...
            this.coordinatesHeder.SizeF = new System.Drawing.SizeF(141.6667F, 36.54166F);
            this.coordinatesHeder.Text = "Координаты стыка (пикет + расстояние, м)";
            // 
            // jointNumberHeder
            // 
